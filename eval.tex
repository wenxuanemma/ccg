...
\begin{figure}[!ht]
  ...
  \vspace{-0.2in}
  \caption{\em \small Microbenchmark results. \fixme{CCG instead of Uncertain?}}
  \vspace{-0.15in}
...
\begin{figure}[!th]
  \centering
  \vspace{-0.1in}
  \subfigure[Data center network setting \fixme{change name of $C^3$ to CCG here and elsewhere}]{\includegraphics[scale=0.6,trim=0mm 0mm 0mm 10mm]{figs/emulation_4ms}}%
  \vspace{-0.1in}
